...
public class CurrentUserDTO {
    ...
    public CurrentUserDTO(Integer idUser, String name, String lastName, String secondLastName, String email, String controlNumber, String careerName, ImageProfileModel imageProfile) {
        this.idUser = idUser;
        this.name = name;
